...
public class Habitat {
    ...
    public float getAngleN() { return angleN; }

    public void setN1(int tmp) { N1 = tmp; }
    public void setN2(int tmp) { N2 = tmp; }
    public void setK(int tmp) { K = tmp; }
    public void setV(int tmp) { V = tmp; }
    public void setN(int tmp) { N = tmp; }
    public void setP(float tmp) { P = tmp; }
    public void setAngleN(float tmp) { angleN = tmp; }
    ...
    public Bee create(double xmax, double ymax, Class type, long time, double deathTime) throws FileNotFoundException {
        ...
        if (type == Drone.class) {
            res = new Drone(x, y, imgPath2, id, time, deathTime);
        }

        if (type == Worker.class) {
            res = new Worker(x, y, imgPath, id, time, deathTime);
        }
