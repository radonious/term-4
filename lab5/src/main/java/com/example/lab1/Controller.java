...
public class Controller implements Initializable {
    ...
    public void stopSimulation() {
        ...
        isStarted = false;
        Stream.of(workerAI, droneAI).forEach(BaseAI::pauseAI);
        getTimeLabel().setText("Time: " + simulationTime);
        labelReset();
        habitat.clearData();
    ...
    private void newModalWindow() {
        if (InfoCheckBox.isSelected()) {
            ...
            Label data = new Label("Time: " + simulationTime +
                    "\n\nCount: " + population);
    ...
    public void saveCustomConfig() throws IOException {
        ...
        fileChooser.setInitialFileName("custom_config.txt");
    ...
    @FXML
    public void loadCustomConfig() throws IOException, ClassNotFoundException {
        FileChooser fileChooser = new FileChooser();
    ...
    public void loadConfigOnStart() throws IOException, ClassNotFoundException {
        File file = new File(System.getProperty("user.dir") + "/src/main/resources/com/example/lab1/config/default.txt");
        if (file.createNewFile()) {
            System.out.println("Default config file created, config was not loaded");
        } else System.out.println("Default config file already exists, config was loaded");
        load(file);
    }
    ...
    public void saveConfigOnClose() throws IOException {
        File file = new File(System.getProperty("user.dir") + "/src/main/resources/com/example/lab1/config/default.txt");
        if (file.createNewFile()) {
            System.out.println("Default config file created, config was updated");
        } else System.out.println("Default config file already exists, config was updated");
        checkPaneSettings();
        save(file);
    }
}